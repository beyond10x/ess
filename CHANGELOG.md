...
- Source-pinned normalization library with strict `ess-normalization/1` recipes,
  ...
  Go/Rust/TypeScript adapter generation remains pending; this does not turn structural
  data libraries into application decoders.
...
- Root-selected structural type planning over checked schema bundles and accounted
  ...
  target report. ESS-model field integration and application decoder semantics remain pending.
