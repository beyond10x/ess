...
All pass output lives under `home-path:sha256:fe5db15a4d5bbc691275782abe3ef85ed37af7ad9df723b03154403615eae7da`: this report, read-only command/output captures named `adversary-*`, final clean-state captures and report checksum. The existing fixture helper was read and executed unchanged. No tracked or untracked source, document or test was written. No AEP command, Git mutation, build, live service request, publication or cleanup operation was performed. No active process is retained by this pass. Writes are relinquished with this report; fixes belong to the coordinator's routed implementor.
