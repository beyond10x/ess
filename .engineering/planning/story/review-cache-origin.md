...
- **Acceptance boundary:** F11 explicitly identifies both bundle and chart cache trust; the current story acceptance is bundle-specific. Recommend an explicit both-cache acceptance clarification before selecting the shared implementation — inferred.
...
The 2026-09-06 independent scope report is sealed at SHA256 e6cd5709142582cc406fe8583c23045c71b0fcb3b0ce411119fb0e68ad6da69a; root verified 42 input and 18 local evidence files. Four local ORAS commands establish the installed bundle publisher shape using synthetic payload bytes, not ESS cache correctness or actual Helm publisher bytes. Coordinator candidate binding v1 is SHA256 719c29e9f36a67990133c74f33a71b372e4b6ed90c23dd41bfa640af39ef7985 and is under independent document review. Binding acceptance and fresh integrated source/scheduling remain pending; this story is not selected by wave 11.
