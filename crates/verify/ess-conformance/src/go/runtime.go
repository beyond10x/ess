...
// and regenerate. The suite it runs is in suite.go beside this file.
//
// # What you write
//
...
// one `aep plan artifact evidence --from` reads. The same shape the Rust runner writes, so a
// workflow system adapting one adapts the other.
//
