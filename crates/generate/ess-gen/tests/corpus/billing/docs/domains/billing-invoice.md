...
contract digest slice-sha256/2:cb634bd5e6f1afa6ebc8e9dca752e9901a9a68a2e51fc5009d099f155680606c
...
**`accepted`** — The invoice is created in Draft. Taken when `amount.amount > 0` holds of the input. It creates a `billing.invoice.Invoice`, which starts in `Draft`. The new instance's identity is published as `invoice_id` on `billing.invoice.InvoiceCreated`. It emits `billing.invoice.InvoiceCreated`. It sets `account_id` from `input.account_id` and `total` from `input.amount`. A test reaches it by constructing an input that satisfies that condition.
...
Generated from billing v3 · model digest `56090788443a14b4a51ad151eb5cb3ebded2b98f6defe9ac50826296ac5d0942` · contract digest `slice-sha256/2:cb634bd5e6f1afa6ebc8e9dca752e9901a9a68a2e51fc5009d099f155680606c`. Do not edit this file; change the specification and regenerate it with `ess generate`.
