...
contract digest slice-sha256/2:003eb0f2aab6cc1251288e3dc03526173e257f09b6a592df36618cff9d431d67
...
**`accepted`** — The order is recorded, in Placed. Taken when `weight_grams >= 0` holds of the input. It creates a `oracle.order.Order`, which starts in `Placed`. The new instance's identity is published as `order_id` on `oracle.order.OrderPlaced`. It emits `oracle.order.OrderPlaced`. It sets `weight_grams` from `input.weight_grams`. A test reaches it by constructing an input that satisfies that condition.
...
Generated from oracle v1 · model digest `7ca8e1ba4935adbffad0c3e57e1d7651c7397a5c9b52f6d0cd54488cba83fb2b` · contract digest `slice-sha256/2:003eb0f2aab6cc1251288e3dc03526173e257f09b6a592df36618cff9d431d67`. Do not edit this file; change the specification and regenerate it with `ess generate`.
