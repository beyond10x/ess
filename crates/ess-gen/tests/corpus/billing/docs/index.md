...
- **[Invoicing](domains/billing-invoice.md)** (`billing.invoice`) — Issuing invoices and tracking whether they are paid. Eight types, two entities, two views, four commands, four events, two errors and two actors.
