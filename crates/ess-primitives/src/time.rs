...
/// A report envelope may separately say when it entered a log; this says when the observation
/// behind it was made, and the caller supplies it because the caller is the only party that knows.
///
