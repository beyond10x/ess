...
| Schemas and imports | ess-gen, ess-openapi, schema-contract | generator-schema/openapi/asyncapi, shared-schema-mapping, external-schema-import; schemas/generated and generated/schema/openapi/asyncapi | Same supported semantics, source accounting and explicit refusals; new generic protobuf import is deferred to task:deferred-protocol-ui-bindings |
...
| Conformance and reports | ess-conformance, existing Rust/Go runners and browser replay | conformance-*, coverage-*, suite-admission, browser-* and CLI coverage tests | Preserve existing versions, runners, defaults and refusal sensitivity; add independent service/runtime acceptance; new UI observations and Flutter/Playwright emitters are deferred to task:deferred-protocol-ui-bindings |
...
refused cells, not this prose. New service and ER runtime capabilities remain current acceptance
work. Generic protobuf/UI/Flutter capabilities are deferred to task:deferred-protocol-ui-bindings
and do not block initiative:ess-evolution under approved revision ess-evolution-20260915/1.
