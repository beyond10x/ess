...
| Every admission owner | Guard; entity; struct/newtype invariant; filter; authored satisfies; direct compile of a specification mutated after assembly | Existing normative fixtures still assemble/compile; direct compiler and assembly agree |
