# AEP — Artifact Model Extension v0.1

> **Status:** Additive design extension  
> **Relationship to prior draft:** This document extends the original *AEP — Design Draft v0.1*. It does not replace or correct the original design.  
...
> Define enough artifact semantics for machine-executable AEP to reason about engineering intent, design, decisions, review, verification, and operational knowledge.
