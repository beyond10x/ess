...
| A protocol document's `phases:` block | `website/docs/reference/vocabulary.md:103` — "decomposition verification-setup adversarial-verification" | open | `protocols/aep/1.yaml:phases` | — | — | — |
| A protocol document's `observables:` block | `website/docs/reference/vocabulary.md:109` — "A predicate may only read these" | open | `protocols/aep/1.yaml:observables` | — | — | — |
| A protocol document's `scales:` block | `website/docs/reference/vocabulary.md:125` — "on non-numeric values" | open | `protocols/aep/1.yaml:scales` | — | — | — |
