...
before wave 3 landed), `docs/reviews/AEP Repository Review — Pre-Wave-4 Readiness.md`
...
| `Cargo.toml:24` | `repository = "https://github.com/beyond10x/aep"` | the remote is `unrelated-predecessor/aep` |
