# ESS review boundaries wave 9 — complete opening computation

Raw output of `aep plan artifact waves --kind story --status draft --format json`,
2026-09-06 after published main6c6620b reconciliation and fresh composition scope.
Exit0; the complete waves/collisions/unassessed/cycles value is retained unchanged.
This is historical planning evidence, not a claim that every inferred future path exists.
...
```json
{
  ...
  "collisions": [
    ...
    },
    {
      ...
      "b": "story:normalization-followup-publication",
      "path": "CHANGELOG.md",
      "confidence": "cited"
    },
    {
    ...
    {
      "a": "story:normalization-followup-publication",
      "b": "story:review-composition-contract",
      "path": "website/docs/reference/formats.md",
      "confidence": "cited"
    },
