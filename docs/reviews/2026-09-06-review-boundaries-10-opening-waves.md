# Wave10 opening computation

Exact output of `aep plan artifact waves --kind story --status draft --format json`
after the schema story scope refresh. Exit0. All lists are retained verbatim.
...
```json
{
  ...
  "collisions": [
    ...
    {
      "a": "story:review-schema-resource-identity",
      "b": "story:typescript-normalization-target",
      "path": "website/docs/guides/generate-artifacts.md",
      "confidence": "cited"
    },
