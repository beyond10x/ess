# Wave 15 scope computation

Complete direct output of `aep plan artifact waves --kind story --status draft --format json`, exit zero. Read before selecting the one browser unit; literal scope tokens do not subsume directory descendants.
